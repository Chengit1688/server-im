...
type TeamMemberInfoReq struct {
	OperationID string `json:"operation_id" form:"operation_id" binding:"required"`
	ShopID      int64  `json:"shop_id" binding:"required,number"`
	UserID      string `json:"user_id"`
}
type TeamMemberInfoResp struct {
	ShopID   int64    `json:"shop_id" binding:"required,number"`
	UserID   string   `json:"user_id"`
...
type RemoveTeamReq struct {
	OperationID string `json:"operation_id" form:"operation_id" binding:"required"`
	ShopID      int64  `json:"shop_id" binding:"required,number"`
	UserID      string `json:"user_id"`
}

type IDCommonReq struct {
	OperationID string `json:"operation_id" form:"operation_id" binding:"required"`
	ShopID      int64  `json:"shop_id" binding:"required,number"`
}
...
type AgentLevelListResp struct {
	List []AgentLevelListInfo `json:"list"`
	pagination.Pagination
}

type AgentLevelListInfo struct {
	ShopID    int64  `json:"shop_id"`
	ShopName  string `json:"shop_name"`
	CreatedAt int64  `json:"created_at"`
	TeamInfo
